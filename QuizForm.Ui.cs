...
namespace MathQuizLocker
{
	public partial class QuizForm
	{
		...
		private void LayoutCombat()
		{
			...
			// Character and Dice positioning (Skipped if animating to avoid jitter)
			if (!_isAnimating)
			{
			...
			// Answer Input and Attack Button
			...
			// Victory Menu Buttons (Always calculate location so they aren't stuck at 0,0)
