...
namespace MathQuizLocker
{
	public class QuizForm : Form
	{
		...
		private void InitializeCombatUi()
		{
			...
			// 1. Sprites - Reverted to your original 350x450 size
			...
			// 6. Navigation Buttons (Post-Victory)
			_btnContinue = new Button { Text = "CONTINUE FIGHTING", Size = new Size(350, 80), FlatStyle = FlatStyle.Flat, BackColor = Color.ForestGreen, ForeColor = Color.White, Font = new Font("Segoe UI", 18, FontStyle.Bold), Visible = false };
			_btnContinue.Click += (s, e) => ResetForNextFight();

			_btnExit = new Button { Text = "EXIT TO DESKTOP", Size = new Size(350, 80), FlatStyle = FlatStyle.Flat, BackColor = Color.Goldenrod, ForeColor = Color.Black, Font = new Font("Segoe UI", 18, FontStyle.Bold), Visible = false };
			...
			this.Controls.AddRange(new Control[] { _picKnight, _picMonster, _die1, _die2, _monsterHealthBar, _playerHealthBar, _playerXpBar, _lblLevel, _lblXpStatus, _txtAnswer, _btnSubmit, _lblFeedback, _btnReset, _btnExit, _btnContinue });
		...
		private void LayoutCombat()
		{
			...
			// Reverted Sprites to your original positions from the Slime screenshot
			_picKnight.Location = new Point((int)(w * 0.30), (int)(h * 0.55));
			_picMonster.Location = new Point((int)(w * 0.60), (int)(h * 0.60));
			...
			// Victory Buttons
			_btnContinue.Location = new Point(w / 2 - _btnContinue.Width / 2, h / 2 - 100);
		...
		private void BtnSubmit_Click(object sender, EventArgs e)
		{
			...
			else
			{
				...
				_lblFeedback.Text = $"Ouch! You took {monsterDmg} damage!";
