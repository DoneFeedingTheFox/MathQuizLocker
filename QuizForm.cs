...
namespace MathQuizLocker
{
	public class QuizForm : Form
	{
		...
		private void InitializeCombatUi()
		{
			...
			this.KeyDown += (s, e) => {
				// Emergency Bypass: Ctrl + Shift + Alt + End
		...
		private void LayoutCombat()
		{
			...
			// Calculate scale based on 1080p height reference
			float scale = h / 1080f;
			...
			// 2. Sprite Scaling & Grounding (0.75h represents the ground line on path)
		...
		private void HandleDeath()
		{
			...
			// Explicitly use the Windows Forms Timer to resolve ambiguity
